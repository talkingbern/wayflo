...
const DESTINATIONS = [
  ...
  "Medellin, Colombia","Lisbon, Portugal","Budapest, Hungary",
...
const ORIGINS = [
  ...
  "Toronto, Canada","Berlin, Germany","Sao Paulo, Brazil",
];
  ...
  return (
    <select
      ...
      style={{
        ...
        cursor:"pointer",
        ...(f ? { borderColor:"var(--rust)", boxShadow:"0 0 0 3px rgba(196,98,45,0.1)" } : {}),
        ...style,
      }}
      onFocus={()=>setF(true)}
      onBlur={()=>setF(false)}
...
function DayCard({ day, index }) {
  ...
  return (
    <div style={{
      ...
      borderRadius:"10px", padding:"1.1rem 1.3rem",
...
function PaywallBanner({ onSignIn, onPay, user }) {
  return (
    <div style={{ background:"var(--white)", border:"2px solid var(--rust)", borderRadius:"12px", padding:"1.5rem", textAlign:"center", marginBottom:"1.5rem", animation:"fadeUp 0.3s ease both" }}>
      <div style={{ fontFamily:"'Playfair Display', serif", fontSize:"1.2rem", fontWeight:900, marginBottom:"0.4rem" }}>
        Your free trip is used up
      </div>
      ...
      {!user ? (
        <button
          onClick={onSignIn}
          style={{ padding:"0.72rem 1.5rem", background:"var(--rust)", border:"none", borderRadius:"8px", color:"#fff", fontSize:"0.9rem", fontWeight:500, cursor:"pointer", fontFamily:"'DM Sans', sans-serif" }}
        >
          Sign in to continue
        </button>
      ) : (
        ...
        <div style={{ display:"flex", alignItems:"center", gap:"0.6rem" }}>
          ...
          {user && (
            <button
              ...
              style={{ background: showHistory ? "var(--sand)" : "none", border:"1.5px solid var(--sand)", borderRadius:"6px", padding:"0.35rem 0.85rem", fontSize:"0.76rem", cursor:"pointer", color:"var(--warm-mid)", fontFamily:"'DM Sans', sans-serif", whiteSpace:"nowrap" }}
            >
          ...
          {user ? (
            <div style={{ display:"flex", alignItems:"center", gap:"0.6rem" }}>
              <span style={{ fontSize:"0.73rem", color:"var(--warm-mid)", maxWidth:140, overflow:"hidden", textOverflow:"ellipsis", whiteSpace:"nowrap" }}>{user.email}</span>
              <button
                onClick={signOut}
              ...
              <div style={{ animation:"fadeUp 0.4s ease both" }}>
                <div style={{ marginBottom:"1.75rem" }}>
                  <h1 style={{ fontFamily:"'Playfair Display', serif", fontSize:"clamp(1.9rem,7vw,2.9rem)", fontWeight:900, lineHeight:1.1, marginBottom:"0.5rem", color:"var(--ink)" }}>
                    <span style={{ color:"var(--ink)" }}>Where are you</span><br />
              ...
              <div style={{ animation:"fadeUp 0.4s ease both" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    background: saved ? "var(--green)" : saving ? "var(--warm-mid)" : "var(--ink)",
                    border:"none", borderRadius:"8px", color:"var(--paper)",
                    fontSize:"0.92rem", fontWeight:500,
                    cursor: saved || saving ? "default" : "pointer",
                    fontFamily:"'DM Sans', sans-serif", marginBottom:"0.85rem",
                ...
                <div style={{ background:"var(--card-bg)", border:"1px solid var(--sand)", borderRadius:"10px", padding:"1.15rem" }}>
                  ...
                  />
                  {error && (
                    <div style={{ fontSize:"0.78rem", color:"var(--rust-dk)", marginBottom:"0.5rem" }}>{error}</div>
                  )}
                  <button
                    onClick={refine}
